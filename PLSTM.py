...
class PLSTM(object):
  ...
  def __init__(self,
    ...
    with tf.compat.v1.variable_scope('net'):
      ...
      self.skel_input = tf.compat.v1.placeholder(dtype=tf.float32, shape=(batch_size, g_T_size, g_feat_dim), name='skel_input')
      self.action_gt = tf.compat.v1.placeholder(dtype=tf.float32, shape=(batch_size, g_num_action), name='skel_action_gt')
      self.plstm_keep_prob = tf.compat.v1.placeholder(dtype=tf.float32)
